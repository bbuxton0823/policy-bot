...
export async function POST(req: NextRequest) {
  try {
    ...
    if (useWebSearch) {
      ...
      // Add specific instructions for document search
      runOptions.instructions = `IMPORTANT: Please search through the uploaded documents to answer this query. Use the file_search tool to find relevant information in the documents. If you cannot find relevant information in the documents, please inform the user that the information could not be found in the uploaded documents.`;
    }
